...
<!-- displaing the company's three expenses handling margin and surcharges as defined by company -->
<table class="table table-striped">
    <?php
...
<!-- adding up demand effect costs to total costs -->
<?php
...
<!-- getting the handling charges of company -->
<?php
        $percentofcomp=0;
        //echo $weather;
...
<!-- adding up margin costs to total costs -->
<?php
...
<!-- adding up surcharges costs to total costs -->
<?php
